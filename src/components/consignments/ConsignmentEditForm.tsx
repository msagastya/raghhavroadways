...
export default function ConsignmentEditForm({ consignment, companies, allParties, agents, vehicles }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    fromState:      consignment.fromState,
    ...
    invoiceChallanNo: consignment.invoiceChallanNo ?? "",
    challanDocUrl:    consignment.challanDocUrl    ?? "",
    vehicleId:        consignment.vehicleId        ?? "",
    driverName:     consignment.driverName     ?? "",
    driverPhone:    consignment.driverPhone    ?? "",
    vehicleFreight: consignment.vehicleFreight ? String(consignment.vehicleFreight) : "",
    advancePaid:    String(consignment.advancePaid),
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    start(async () => {
      const r = await updateConsignment(consignment.id, data)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl"
            ...
            <div>
              ...
              <p className="text-[14px] font-bold text-brand-900 mt-0.5 font-mono">{consignment.lrNumber}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col justify-end">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-brand-900/40 mb-1.5">Balance</p>
